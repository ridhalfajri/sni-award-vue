              ...
              <ul class="nav nav-pills">
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu">
                    ...
                    >
                    <a class="dropdown-item" href="#"
                      ><i class="dropdown-icon fa fa-file-pdf-o"></i> PDF</a
                    >
                  </div>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <ul class="list-unstyled feeds_widget">
                      <li>
                        ...
                        <div class="feeds-body">
                          ...
                          <small
                            >It will give a smart finishing to your site</small
                          >
                        </div>
                      </li>
                      <li>
                      ...
                      <li>
                        ...
                        <div class="feeds-body">
                          ...
                          <small
                            >WE have fix all Design bug with Responsive</small
                          >
                        </div>
                      </li>
                      <li>
                ...
                <div class="dropdown d-flex">
                  ...
                  >
                    ...
                    <a class="dropdown-item" href="app-setting.html"
                      ><i class="dropdown-icon fe fe-settings"></i> Settings</a
                    >
                    <a class="dropdown-item" href="app-email.html"
                      ><span class="float-right"
                        ><span class="badge badge-primary">6</span></span
                      ><i class="dropdown-icon fe fe-mail"></i> Inbox</a
                    >
                    <a class="dropdown-item" href="javascript:void(0)"
                      ><i class="dropdown-icon fe fe-send"></i> Message</a
                    >
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="javascript:void(0)"
